...
public class UIRegressionTestRunner implements GrailsTestRunner {
    ...
    public UIRegressionTestRunner(File reportsDir, List<String> formats) {
    ...
    public TestResult runTests(TestSuite suite) {
        ...
        for (Enumeration tests = suite.tests(); tests.hasMoreElements();) {
            ...
            System.out.println(junitTest.toString());
            try {
